...
[https://belgeler.yazbel.com/python/beautiful-soup](https://belgeler.yazbel.com/python/beautiful-soup)

YazBel projesi Beautiful Soup belgelerine hoşgeldiniz!
...
Her zaman [YazBel forumu](https://forum.yazbel.com/)nun
[Beautiful Soup kategorisi](https://forum.yazbel.com/c/python/beautiful-soup)nde bir konu açarak aklınızdaki soruları
sorabilirsiniz. Topluluk size yardım etmekten mutluluk duyacaktır.
...
edin. Ayrıca konuya, sağ taraftaki **Labels** bölümünden `beautiful-soup` etiketini eklediğinize de emin olun.

- [Forumun Beautiful Soup kategorisi](https://forum.yazbel.com/c/python/beautiful-soup)nde sorulan soruları
cevaplayabilirsiniz.
